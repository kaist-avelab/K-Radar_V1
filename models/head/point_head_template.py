...
from utils.ops.roiaware_pool3d import roiaware_pool3d_utils
...
class PointHeadTemplate(nn.Module):
    def __init__(self, model_cfg, num_class):
        ...
        self.build_losses(self.model_cfg.MODEL.POINT_HEAD.LOSS_CONFIG)
    ...
    def get_cls_layer_loss(self, tb_dict=None):
        ...
        loss_weights_dict = self.model_cfg.MODEL.POINT_HEAD.LOSS_CONFIG.LOSS_WEIGHTS
